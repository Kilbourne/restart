...
function wp_ozh_adminmenu () {
	...
	global $current_user;
      get_currentuserinfo();
	$ozh_menu .= "<li class='custom-user-profile'><span><a  href='";
	$ozh_menu .=admin_url( 'profile.php');
$ozh_menu .=	"' class='user-menu dropdown-toggle'>";
$ozh_menu .= get_avatar( $current_user->ID,40);
$ozh_menu .="<span class='user_info'>";
$ozh_menu .= $current_user->display_name;
$ozh_menu .= "</span></a></span><span class='logout'><a href='";
$ozh_menu .= wp_logout_url( home_url() ); 
$ozh_menu .= "/wp-admin'>Esci</a></span> </li></ul></div>";
