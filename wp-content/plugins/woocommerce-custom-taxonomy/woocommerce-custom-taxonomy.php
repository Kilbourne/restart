...
class pe_wc_product_custom_taxonomy
{
    var $taxonomies = array(
     'sottotitolo','ruolo','nome','cognome','autore','curatore','traduttore','anno di pubblicazione','editore','numero di pagine','lingua','isbn','legatura','condizone','commento condizione','particolari','collana','quarta','sinossi','recenzione','soffietto','deposito'
    );
    ...
    function register_taxonomy($taxonomy_name)
    {
        ...
        register_taxonomy('pa_'.$taxonomy_name, 'product', $args);
        register_taxonomy_for_object_type( 'pa_'.$taxonomy_name, 'product' );
    }
